    ...
    return (
        <footer className="bg-gray-300 py-12">
            <div className="mx-auto max-w-screen-xl px-4 py-6 sm:px-6 lg:px-8">
                <div className="lg:flex-col lg:items-center lg:gap-8">

                    <div className="mt-8 grid grid-cols-2 gap-8 lg:mt-0 lg:grid-cols-4">
                        

                        <div className="col-span-2 lg:col-span-5 lg:flex lg:items-end">
                            <div className="w-full grid grid-cols-1 md:grid-cols-2 gap-8 items-start">
                                <div className="flex flex-col gap-4">
                                    <Link to="/">
                                        <img className="md:w-32 w-12" src={assets.logo_img} />
                                    </Link>
                                ...
                                <div className="w-full bg-gray-800 rounded-lg shadow-md p-6">
                                    ...
                                    <form className="flex flex-col">
                                        <input
                                            ...
                                            type="email"
                                        />
                                        <button className="bg-gradient-to-r from-green-500 to-blue-500 text-white font-bold py-2 px-4 rounded-md">
                                            Subscribe
                                        </button>
                                    </form>
                                </div>
